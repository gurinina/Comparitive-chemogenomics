...
####  foldenrichment = (interSect/nQuery) (runGO)/(nGenes /total number of rows in unigene set (matrix))
...
########
#bp_file = readSigs("BP_geneNames_current.gmt")
########
...
runGOENRICH = function (fdrThresh = 0.1, curr_exp, score, minSetSize =5, bp_path, go_path = NULL){
  ...
  bp <- bp[lens >= minSetSize & lens <= 300]
